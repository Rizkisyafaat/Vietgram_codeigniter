        ...
        <main id="login">
            ...
            <div class="login__column">
                <div class="login__box">
                    ...
                    <form action="<?= base_url('controller_login'); ?>" method="post" class="login__form">
                    ...
                    <a href="#" class="login__link login__link--small">Forgot passsword</a>
                </div>
                <div class="login__box">
                    <span>Don't have an account?</span> <a href="<?= base_url('controller_register'); ?>">Sign up</a>
                </div>
